      ...
      <div className="logo-languages">
        ...
        <div className="intro-content">
          <div className="intro-text">
            <h3 className="intro_app">{t("SALARY")}</h3>
            <h2 className="intro_title">{t("intro_title")}</h2>
            <h2 className="intro_title_2">{t("Salary Benchmarking")}</h2>
            <p className="intro_description">
              {t(
                "Trusted data that you need to land a new job or make the right compensation decision with confidence."
              )}
            </p>
          </div>
